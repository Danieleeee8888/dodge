...
- **Home:** titolo **DODGE** (pallini invisibili, spazio ok), nome utente; **GIOCA** **più grande** al centro rispetto a CO‑OP / 1‑VS‑1; **distanze ridotte** titolo → modalità → pallini bonus (come ref. “foto 2”). Barra bassa: audio | classifica gialla | profilo blu su nero. `padding-top` +1.5cm come prima.
