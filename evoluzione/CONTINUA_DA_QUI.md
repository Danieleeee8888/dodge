...
- **Admin overview:** KPI e distribuzione soglie (con percentuali sul totale partite archivio) solo dalla collezione **`scores`** (`ms`, `createdAt`) in `GET /api/admin/overview`; finestre 24h/7gg solo su documenti con data creazione leggibile.
