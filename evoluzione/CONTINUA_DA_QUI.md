...
- Avvio da browser non installato: nudge installazione (`#installNudge`) mostrato ad ogni apertura; su Android usa `beforeinstallprompt` quando disponibile, su iOS mostra istruzioni “Condividi → Aggiungi a Home”.
