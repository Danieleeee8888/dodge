...
// â??â?? viste â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
const $v = {
...
// â??â?? messaggi â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
...
// â??â?? loading bottoni â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
function setLoading(id, on) {
  const btn = document.getElementById(id);
  if (!btn) return;
  if (on) { btn._t = btn.textContent; btn.textContent = 'Â·Â·Â·'; }
  else { btn.textContent = btn._t || btn.textContent; }
  btn.disabled = on;
}

// â??â?? messaggi di errore in italiano â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
function errText(err) {
  const map = {
    ...
    'auth/account-exists-with-different-credential': 'Questa email Ã¨ giÃ  associata a un altro metodo di accesso.',
    ...
    'USERNAME_TAKEN':               'Username giÃ  in uso. Scegline un altro.',
...
// â??â?? validazione username â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
...
async function completeGoogleSignIn(user) {
  try {
    ...
    // il profilo puÃ² essere completato in un secondo momento.
...
document.getElementById('form-register').addEventListener('submit', async (e) => {
  ...
  try {
    if (await usernameExists(username)) {
      setMsg('register', 'Username giÃ  in uso. Scegline un altro.');
      return;
    }
...
// â??â?? VERIFICA: "Ho verificato, entra" â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
...
// â??â?? VERIFICA: reinvia email â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
document.getElementById('btn-resend').addEventListener('click', async () => {
  ...
  try {
    ...
    setMsg('verify', 'Non Ã¨ stato possibile reinviare. Riprova piÃ¹ tardi.');
  } finally {
    setLoading('btn-resend', false);
  }
});

// â??â?? NAVIGAZIONE â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
[
...
// â??â?? STATO AUTH: se giÃ  loggato e verificato â?? vai al gioco â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??â??
